...
VIDEO_DIR = config.INPUT_VIDEO_DIR  # Using INPUT_VIDEO_DIR directly from config
ANALYSIS_DIR = config.ANALYSIS_DIR
LOG_DIR = config.LOG_DIR
CSV_DIR = config.CSV_DIR  # config.CSV_DIR is already ANALYSIS_DIR + "/CSV"
EXCEL_DIR = config.EXCEL_DIR  # config.EXCEL_DIR is already ANALYSIS_DIR + "/Excel"
