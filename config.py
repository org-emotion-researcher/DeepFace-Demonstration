...
VIDEO_PATH = "videos for AFEA demonstration"    # Folder with the input video files to be analysed.
ANALYSIS_DIR = "raw data output files"          # Folder where analysis CSV/Excel files are saved.
